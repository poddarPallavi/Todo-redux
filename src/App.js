  ...
  return (
    <div className="App">
     <header className="App-header">
       <h2>TO DO List App with REDUX</h2>
        ...
        <ul className="allTodos">
          {
            todos && todos.map((t)=>(
              ...
              <button style={{borderRadius:25, padding:10, border:"1px solid white", color:"white", backgroundColor:"orangered"}} onClick={()=>removeHandler(t)}>Delete</button>
            </li>
            ))
          } 
        </ul>
        <h5> Happy Coding &copy; By Pallavi</h5>
     </header>     
    </div>
  );
}
